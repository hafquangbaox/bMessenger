            ...
            window: {
                'flipMirror': [
                    ...
                    },
                    {
                        isComponent: "name",
                        block: 'div[data-pagelet="root"] div[data-pagelet="ChatTab"] div[data-visualcompletion="ignore-dynamic"] div[role="region"]>div>div>div>div:last-child>div>div:first-child',
                        blockSelector: ' div[data-testid="outgoing_group"]>div[class]>div>div>div',
                        inlineNears: true,
                        blockNears: false,
                    },
                    {
                        isComponent: "message",
                        block: 'div[data-pagelet="root"] div[data-pagelet="ChatTab"] div[data-visualcompletion="ignore-dynamic"] div[role="region"]>div>div>div>div:last-child>div>div:first-child',
                        blockSelector: ' div[data-testid="outgoing_group"]>div:not([class]) div[data-scope="messages_table"]>span',
                        inlineNears: true,
                        blockNears: false,
                    },
                    {
...

                    {
                        isComponent: "message",
                        block: 'div[data-pagelet="root"] div[data-pagelet="ChatTab"] div[data-visualcompletion="ignore-dynamic"] div[role="region"]>div>div>div>div:last-child',
                        blockSelector: ' div>div:first-child  div[data-testid="outgoing_group"]>div:not([class])>div[role="row"]>div>div>div>div>div:nth-child(1)',
                        inlineNears: true,
                        blockNears: false,
                    },
